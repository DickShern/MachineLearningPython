# -*- coding: utf-8 -*-
"""
Created on Mon Oct 31 14:39:01 2016
...
print ("Normal Cost Function: %f" % computeCost(flattenParams(myThetas),flattenX(X),y))
...
myThetas = [ Theta1, Theta2 ]
print ("Regularized cost function %f" % computeCost(flattenParams(myThetas),flattenX(X),y,mylambda=1.))
